                        ...
                        <fieldset class="customerFilter">
                            ...
                            <div class="select">
                                <select id="customerFilter" wire:model="selectedCustomerId">
                                    ...
                                    @if(is_reseller())
                                        <option value="merged">Merged Child Accounts</option>
                                    @endif
                            ...
                            <div class="image">
                                <svg width="46" height="47" viewBox="0 0 46 47" fill="none"
                                    ...
                                    <path fill-rule="evenodd" clip-rule="evenodd"
                                          d="M32.75 22.75C33.1642 22.75 33.5 23.0858 33.5 23.5V28.75C33.5 29.1642 33.1642 29.5 32.75 29.5H27.5C27.0858 29.5 26.75 29.1642 26.75 28.75C26.75 28.3358 27.0858 28 27.5 28H32V23.5C32 23.0858 32.3358 22.75 32.75 22.75Z"
                                          fill="#E76C21"/>
                                    <path fill-rule="evenodd" clip-rule="evenodd"
                                          d="M12.7197 17.7197C13.0126 17.4268 13.4874 17.4268 13.7803 17.7197L19.4695 23.4089L19.4696 23.4089C19.5393 23.4786 19.6219 23.5339 19.7129 23.5716C19.804 23.6093 19.9015 23.6287 20 23.6287C20.0985 23.6287 20.196 23.6093 20.2871 23.5716C20.3781 23.5339 20.4607 23.4786 20.5304 23.4089L20.5305 23.4089L22.9088 21.0305C22.9088 21.0305 22.9089 21.0305 22.9089 21.0305C23.1178 20.8215 23.3659 20.6557 23.6388 20.5426C23.9119 20.4295 24.2045 20.3713 24.5 20.3713C24.7955 20.3713 25.0881 20.4295 25.3612 20.5426C25.6341 20.6557 25.8822 20.8215 26.0911 21.0305C26.0911 21.0305 26.0912 21.0305 26.0912 21.0305L32.5303 27.4697C32.8232 27.7626 32.8232 28.2374 32.5303 28.5303C32.2374 28.8232 31.7626 28.8232 31.4697 28.5303L25.0305 22.0911L25.0304 22.0911C24.9607 22.0214 24.8781 21.9661 24.7871 21.9284C24.696 21.8907 24.5985 21.8713 24.5 21.8713C24.4015 21.8713 24.304 21.8907 24.2129 21.9284C24.1219 21.9661 24.0393 22.0214 23.9696 22.0911L23.9695 22.0911L21.5912 24.4695C21.3822 24.6785 21.1342 24.8443 20.8612 24.9574C20.5881 25.0705 20.2955 25.1287 20 25.1287C19.7045 25.1287 19.4119 25.0705 19.1388 24.9574C18.8658 24.8443 18.6178 24.6785 18.4088 24.4695L12.7197 18.7803C12.4268 18.4874 12.4268 18.0126 12.7197 17.7197Z"
                                          fill="#E76C21"/>
                                </svg>
                            ...
                            <div class="items-center gap14">
                                <div class="image">
                                    <svg width="46" height="47" viewBox="0 0 46 47" fill="none"
                                        ...
                                        <rect y="0.5" width="46" height="46" rx="23" fill="#FFFBF8"/>
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                                              d="M26.75 18.25C26.75 17.8358 27.0858 17.5 27.5 17.5H32.75C33.1642 17.5 33.5 17.8358 33.5 18.25V23.5C33.5 23.9142 33.1642 24.25 32.75 24.25C32.3358 24.25 32 23.9142 32 23.5V19H27.5C27.0858 19 26.75 18.6642 26.75 18.25Z"
                                              fill="#E76C21"/>
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                                              d="M32.5303 18.4697C32.8232 18.7626 32.8232 19.2374 32.5303 19.5303L26.0912 25.9695C26.0912 25.9695 26.0911 25.9695 26.0911 25.9695C25.8822 26.1785 25.6341 26.3443 25.3612 26.4574C25.0881 26.5705 24.7955 26.6287 24.5 26.6287C24.2045 26.6287 23.9119 26.5705 23.6388 26.4574C23.3658 26.3443 23.1178 26.1785 22.9088 25.9695L20.5305 23.5911L20.5304 23.5911C20.4607 23.5214 20.3781 23.4661 20.2871 23.4284C20.196 23.3907 20.0985 23.3713 20 23.3713C19.9015 23.3713 19.804 23.3907 19.7129 23.4284C19.6219 23.4661 19.5393 23.5214 19.4696 23.5911L19.4695 23.5911L13.7803 29.2803C13.4874 29.5732 13.0126 29.5732 12.7197 29.2803C12.4268 28.9874 12.4268 28.5126 12.7197 28.2197L18.4088 22.5305C18.6178 22.3215 18.8658 22.1557 19.1388 22.0426C19.4119 21.9295 19.7045 21.8713 20 21.8713C20.2955 21.8713 20.5881 21.9295 20.8612 22.0426C21.1342 22.1557 21.3822 22.3215 21.5912 22.5305L23.9695 24.9089L23.9696 24.9089C24.0393 24.9786 24.1219 25.0339 24.2129 25.0716C24.304 25.1093 24.4015 25.1287 24.5 25.1287C24.5985 25.1287 24.696 25.1093 24.7871 25.0716C24.8781 25.0339 24.9607 24.9786 25.0304 24.9089L25.0305 24.9089L31.4697 18.4697C31.7626 18.1768 32.2374 18.1768 32.5303 18.4697Z"
                                              fill="#E76C21"/>
                                    </svg>

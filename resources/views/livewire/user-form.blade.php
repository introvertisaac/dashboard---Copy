    ...
    <div class="wg-box">
        ...
        <div class="row">
            <div class="col-md-6 form-group">
                ...
                <label for="customer" class="body-title mb-3">Customer</label>
                <div class="select">
        ...
        <div class="row">
            <div class="col-md-6 form-group">
                ...
                <label for="email" class="body-title mb-3">Email Address<span
                        class="text-danger">*</span></label>
                <input type="email" wire:model="username" class="form-control" id="email"
                ...
                <span class="mt-4">
                      ...
                      The email address provided will be used as a username for login on the portal as a customer
            ...
            <div class="col-md-6 form-group">
                <label for="phone" class="body-title mb-3">Phone<span
                        class="text-danger">*</span></label>

            ...
            <div class="flex">
                <div class="items-center gap14">
                    ...
                    <div>
                        ...
                        <h4>{{number_format($searches_count)}} <span class="" data-bs-toggle="offcanvas"
        ...
        <div class="offcanvas offcanvas-end tf-bg-light" tabindex="-1" id="offcanvasRight1">
            ...
            <div class="offcanvas-body">
                ...
                <table class="table table-hover table-borderless">
                    ...
                    @foreach($api_group_counts as $api_group_count)

                        <tr>
                            <td>{{service_label($api_group_count->search_type)}}:</td>
                            <td>{{$api_group_count->count}}</td>
                        </tr>
                    @endforeach
                        ...
                        @foreach($activities as $activity)
                            <li class="product-item p-3">
                                ...
                                <div class="flex items-center justify-between flex-grow">
                                    ...
                                    <div>
                                        <a href=""
                                           class="body-title-2">{{$activity->description}} {{(optional($activity->subject)->name) ? ' - '.$activity->subject->name : ''}}</a>
                                        <br>
                                        <div title="{{$activity->created_at}}"
                                             class="text-tiny mt-3">{{$activity->created_at->diffForHumans()}}</div>
